...
class SaludController extends AbstractController
{
    ...
    {
        return $this->render('salud/index.html.twig', ['saluds' => $saludRepository->findAll()]);
    }
    ...
    public function edit(Request $request, Salud $salud): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('salud_index', ['id' => $salud->getId()]);
        }
